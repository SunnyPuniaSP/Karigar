...
const Home = () => {
  ...
  Find skilled, verified technicians for all your home service needs—fast, secure, and hassle-free.
</p>

          <div className="display flex gap-5">
            <Button className="w-75">Book a Service</Button>
            <Button variant="secondary" className="w-75">Track Current Request</Button>
          </div>
        </div>
        <div className="w-1/2">
